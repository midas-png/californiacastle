...
class ApiClient {
   ...
   */
  constructor(
    basePath = 'https://app-a68dd003-3669-4133-8619-984a58c91d85.cleverapps.io/api',
  ) {
    /**
     * The base URL against which to resolve every API call's (relative) path.
     * @type {String}
     * @default https://app-a68dd003-3669-4133-8619-984a58c91d85.cleverapps.io/api
     */
  ...
  hostSettings() {
    return [
      {
        url: 'https://californiacastleapi.onrender.com/api',
